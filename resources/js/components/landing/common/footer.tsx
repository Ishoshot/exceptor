...
export function Footer() {
    ...
    return (
        <footer className="border-border/50 relative border-t py-12">
            <div className="container">
                <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
                    <div className="space-y-4">
                        <Logo />
                        <p className="text-muted-foreground text-sm">Powerful exception monitoring and analysis for modern applications.</p>
                ...
                <div className="border-border/50 mt-10 flex flex-col items-center justify-between gap-4 border-t pt-6 md:flex-row">
                    <div className="text-muted-foreground text-sm">© {currentYear} Exceptor. All rights reserved.</div>
